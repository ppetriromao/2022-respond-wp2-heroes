...
TR16: days worked, should more than 5 days be a stressor?
TR17: hours worked on those days == should that be a stressors
MP25c: stigma, if any agreement then stressor

MP25d: frequency of conflicts, does it make sense to count? 

EP32a: should we include feeling remorse? is that somehow the stressor severity?
...
ds %>%
  mutate(
    ...
    ehc_10 = case_when(EP27a = 1 ~ 1,
                       EP27b = 1 ~ 0,
                       EP27c = 1 ~ 0,
                       EP27d = 1 ~ 0) # received training or not
    )
...
## alternative if this is the renaming issue
