...
psych::pairs.panels(ds1[c("ehc", "ec", "E", "ghq")], 
...
ds1$P_pred = (intercept + ds1$E*E_slope)

ds1$SR= scale(ds1$ghq - ds1$P_pred)
ds1$RES = -(ds1$SR)


psych::pairs.panels(ds1[c("SR", "ghq")], 
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = TRUE,  # show density plots
             ellipses = TRUE, # show correlation ellipses
...
dsc$P_pred = (intercept + dsc$ehc*E_slope)


dsc$SR = scale(dsc$ghq -dsc$P_pred)
dsc$RES <- -(dsc$SR)


psych::pairs.panels(dsc[c("RES", "ghq")], 
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = TRUE,  # show density plots
             ellipses = TRUE, # show correlation ellipses
