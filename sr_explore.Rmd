...
### EHC stressors
    ...
    - MP18aa: Working in a COVID unit. Expected answer format: 0 1. Actual answer format: 1. Basis for: ehc_4
...
### EC stressors
    ...
    - MP18ab: infection. Expected answer format: 0 1 2. Actual 1. Basis for ec_4
    ...
    - MP25aa: death at work. Expected answer format: 0 1. Actual: 1. Basis for: ec_6
...
ds2$ehc_raw <-rowSums(ds2[e_raw], na.rm = FALSE)
...
ds3$ehc_raw <-rowSums(ds3[e_raw], na.rm = FALSE)
